...
export const AnimatedBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 w-full h-full -z-10 pointer-events-none overflow-hidden bg-[#050505]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[80%] bg-white/[0.12] blur-[220px] rounded-full pointer-events-none" />
      
      {/* Top White Soft Light */}
      <div className="absolute top-0 left-0 w-full h-[45%] bg-gradient-to-b from-white/[0.1] to-transparent pointer-events-none" />

      {/* Subtle Bottom Light */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[30%] bg-gradient-to-t from-white/[0.08] to-transparent pointer-events-none" />
